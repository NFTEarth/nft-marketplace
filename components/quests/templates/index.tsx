      ...
      <Box>
        <Flex direction="column" css={{padding: '$3', gap: '$4'}}>
          ...
          >
            ...
            <Text style="subtitle1" css={{color: '$gray11'}}>
              Follow NFTEarth at
              <Link target="_blank" href="https://twitter.com/NFTEarth_L2">
      ...
      <Box>
        <Flex direction="column" css={{padding: '$3', gap: '$4'}}>
          ...
          >
            ...
            <Text style="subtitle1" css={{color: '$gray11'}}>
              Retweet this
              <Link target="_blank" href="https://twitter.com/NFTEarth_L2/status/1693441929491468597">
      ...
      <Box>
        <Flex direction="column" css={{padding: '$3', gap: '$4'}}>
          ...
          >
            ...
            <Text style="subtitle1" css={{color: '$gray11'}}>
              Join.
              <Link target="_blank" href="https://discord.gg/nftearth">
